    ...
    <div className='w-full h-37.5 bg-white/40 shadow-lg p-2 flex justify-between rounded-2xl'>
      ...
      <div className='w-[60%] h-full  flex gap-8'>
        ...
        <div className='w-[40%] h-full flex justify-center flex-col gap-4'>
          <span className='text-lg text-gray-700 font-semibold'>PaneCake</span>
          <div className='w-full bg-white/40  text-orange-500 rounded-2xl p-2 flex shadow-lg overflow-hidden border-2 border-orange-500 font-bold text-lg  gap-2'>
            ...
            <span className='w-[45%] h-full flex justify-center items-center rounded-lg'>1</span>
      ...
      <div className='flex  items-end  justify-center flex-col gap-5 p-3 w-[40%] h-full'>
        <span className='text-lg text-gray-700 font-semibold'>Rs 499/-</span>
        <span className='bg-black/20  hover:bg-orange-500/40 text-orange-500 rounded-full p-2 hover:scale-105 transition-all duration-300 cursor-pointer w-10 h-10 flex justify-center items-center'><MdDelete className='size-6' /></span>
      </div>
    </div>
  )
}
